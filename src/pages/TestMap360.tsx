      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 relative bg-[#09090b] overflow-hidden">
          ...
          <div className="absolute top-6 right-6 px-4 py-2 bg-black/50 border border-neutral-800 rounded-lg text-neutral-500 text-xs font-medium z-10 pointer-events-none flex items-center gap-2">
             <MoveDiagonal size={14}/> Kéo chuột ở khoảng trống để di chuyển Camera
          </div>
            ...
            <div id="map-bg"
              ...
              <svg className="absolute inset-0 w-full h-full pointer-events-none" style={{ zIndex: 10 }}>
                ...
                {edges.map(e => {
                  ...
                  return (
                    <g key={e.id} className="pointer-events-auto cursor-pointer" onDoubleClick={(ev) => { ev.stopPropagation(); setSelectedEdgeId(e.id); setSelectedNodeId(null); setEditingNodeId(null); }}>
